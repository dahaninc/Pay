...
<div style="max-width:560px;margin:0 auto;font-family:-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;color:#1a1d21;">
  <div style="background:#fff;border:1px solid #e5e8eb;border-radius:12px;padding:28px;">
    ...
    ${
      stats.recoveredCents > 0
        ? `<h1 style="font-size:24px;margin:0 0 4px;">PaidUp has recovered ${formatMoney(stats.recoveredCents, biz.currency)} for you 🎉</h1>`
  ...
  <p style="text-align:center;color:#9aa1a9;font-size:12px;margin-top:14px;">PaidUp — send the invoice, we'll chase it.</p>
</div></body></html>`;
